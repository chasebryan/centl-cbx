...
def main() -> int:
    ...
    # q71 is a complete multiplicity-one sink.
    assert EXPECTED[71] == {7, 11, 23, 31}

    # q37 has one new output, at prime k71. k27 is only q3 character again.
    ...
    # Directed acyclic descendant closure after the q317^2 root.
